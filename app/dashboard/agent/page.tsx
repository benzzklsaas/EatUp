      ...
      <main style={{ padding: '40px 24px', maxWidth: 640, margin: '0 auto' }}>
        ...
        <div style={{ marginBottom: 36 }}>
          ...
          <p style={{ color: '#374151', fontSize: 14, margin: 0, lineHeight: 1.6 }}>
            Collez un avis Google — l'IA génère une réponse personnalisée, prête à publier en 10 secondes.
          </p>
        </div>
        ...
        <div style={{ marginBottom: 16 }}>
          <label style={{ display: 'block', fontSize: 11, fontWeight: 700, color: '#4b5563', textTransform: 'uppercase', letterSpacing: '0.08em', marginBottom: 8 }}>Nom du restaurant</label>
          <input
            value={restaurantName}
            onChange={e => setRestaurantName(e.target.value)}
            placeholder="Crousty Naan"
            style={{ width: '100%', borderRadius: 12, padding: '12px 14px', fontSize: 14, background: 'rgba(255,255,255,0.04)', border: '1px solid rgba(255,255,255,0.07)', color: 'white', boxSizing: 'border-box', fontFamily: 'inherit' }}
          />
        </div>
